...
class ReadmeData:
    ...
    def __init__(self) -> None:
        ...
        try:
            ...
            print(Fore.CYAN, Style.BRIGHT,
                  "README JSON CREATED SUCCESSFULLY! IF YOU WANT TO EDIT THE DATA, EDIT IT IN README.JSON AND RUN UPDATES (update_readme())")
    ...
    def set_license(self) -> None:
        ...
        print(
            '7: BSD 3-clause "New" or "Revised" license (bsd-3-clause) \t 8: BSD 3-clause Clear license (bsd-3-clause-clear)')
        print('9: Creative Commons license family (cc) \t\t\t 10: Creative Commons Zero v1.0 Universal (cc0-1.0)')
        print(
            '11: Creative Commons Attribution 4.0 (cc-by-4.0) \t\t 12: Creative Commons Attribution Share Alike 4.0 (cc-by-sa-4.0)')
        print(
            '13: Do What The F*ck You Want To Public License (wtfpl) \t 14: Educational Community License v2.0 (ecl-2.0)')
        print('15: Eclipse Public License 1.0 (epl-1.0) \t\t\t 16: Eclipse Public License 2.0 (epl-2.0)')
        print(
            '17: European Union Public License 1.1 (eupl-1.1) \t\t 18: GNU Affero General Public License v3.0 (agpl-3.0)')
        print('19: GNU General Public License family (gpl) \t\t\t 20: GNU General Public License v2.0 (gpl-2.0)')
        print(
            '21: GNU General Public License v3.0 (gpl-3.0) \t\t\t 22: GNU Lesser General Public License family (lgpl)')
        print(
            '23: GNU Lesser General Public License v2.1 (lgpl-2.1) \t\t 24: GNU Lesser General Public License v3.0 (lgpl-3.0)')
